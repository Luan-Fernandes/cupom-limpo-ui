import { Captions, LockKeyhole, User } from "lucide-react";
    ...
    <div className="bg-white min-h-screen w-full items-center pt-10 pl-[15rem]">
      <div className=" flex  bg-amber-50 w-[944px] h-[561] ml-5 rounded-3xl shadow-2xl ">
        ...
        >
          ...
          <InputRoot>
            <InputControl>
              <User className="absolute -mt-3 ml-3 size-7 text-zinc-400" />
            </InputControl>
            <InputPrefix placeholder="Nome" />
          </InputRoot>

          <InputRoot>
            <InputControl>
              <Captions className="absolute -mt-3 ml-3 size-7 text-zinc-400" />
            </InputControl>
            <InputPrefix placeholder="CPF" />
          </InputRoot>

          <InputRoot>
            <InputControl>
              <LockKeyhole className="absolute -mt-3 ml-3 size-7 text-zinc-400" />
            </InputControl>
            <InputPrefix placeholder="Senha" />
          </InputRoot>
